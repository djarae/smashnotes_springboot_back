...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2025 a las 20:10:24
...
CREATE TABLE `registro` (
  ...
  `idEscenario` int(3) NOT NULL,
  `idPosicion` int(10) NOT NULL,
...
INSERT INTO `registro` (`id`, `idPersonajeEmisor`, `idPersonajeReceptor`, `idMovimiento`, `idEscenario`, `idPosicion`, `porcentajeKo`) VALUES
(1, 35, 63, 7, 1, 1, 98),
(2, 35, 36, 7, 1, 1, 100),
(3, 35, 73, 7, 1, 1, 111),
(4, 35, 66, 7, 1, 1, 114),
